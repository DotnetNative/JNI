...
public unsafe struct Env_
{
    ...
    public IntPtr GetStaticMethodID(IntPtr clazz, byte* name, byte* sig)
    {
        fixed (Env_* env = &this)
    ...
    public RetCode RegisterNatives(IntPtr clazz, NativeMethod_* methods, int nMethods)
    {
        fixed (Env_* env = &this)
    ...
    public JObjRefType GetObjectRefType(IntPtr obj)
    {
        fixed (Env_* env = &this)
