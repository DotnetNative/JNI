...
internal static unsafe class Interop
{
    ...
    [DllImport("kernel32", CharSet = System.Runtime.InteropServices.CharSet.Ansi, ExactSpelling = true, SetLastError = true)]
    public static extern nint GetProcAddress(nint hModule, string procName);

    [DllImport("user32", SetLastError = true, CharSet = System.Runtime.InteropServices.CharSet.Auto)]
